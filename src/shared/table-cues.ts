/**
 * Snapshot transitions that fire the optional delights — haptics here, and
 * sound when that item lands. Both read this module so a reconnect, a mid-turn
...
/**
 * The three haptic events, plus `reveal` so a later sound thud can play for
 * everyone at the table (including a successful doubter who lost no life).
 * Haptics ignore `reveal` and keep using the personal three.
 */
