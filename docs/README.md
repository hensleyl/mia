...
| [client.md](client.md) | The browser side: render-over-snapshot, hold-to-peek, the reconnect lifecycle and its stale-move stamp, the clock-drift correction, why the countdown is updated by hand, and the endgame screen. |
