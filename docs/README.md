...
| [client.md](client.md) | The browser side: render-over-snapshot, the reconnect lifecycle and its stale-move stamp, the clock-drift correction, why the countdown is updated by hand, the spectator screen, and the endgame screen. |
